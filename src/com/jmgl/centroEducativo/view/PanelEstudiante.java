...
//		gridBagLayout.rowWeights = new double[]{Double.MIN_VALUE};
		...
		lblNewLabel_2 = new JLabel("Gestion de Estudiante");
		...
		btnAnterior.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				cargarEnPantalla(ControladorEstudiante.findPrevious(Integer.parseInt(textField.getText())));
			}
		});
		...
		btnSiguiente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				cargarEnPantalla(ControladorEstudiante.findNext(Integer.parseInt(textField.getText())));
			}
		});
	...
	private void guardar() {
		...
		e.setId(Integer.parseInt(this.textField.getText()));
		e.setNombre(this.textField_1.getText());
		e.setApellido1(this.textField_2.getText());
		e.setApellido2(this.textField_3.getText());
		e.setDni(this.textField_4.getText());
		e.setDireccion(this.textField_5.getText());
		e.setEmail(this.textField_6.getText());
		e.setTelefono(this.textField_7.getText());
	...
	private void cargarEnPantalla (Estudiante e) {
		if (e != null) {
			this.textField.setText("" + e.getId());
			this.textField_1.setText(e.getNombre());
			this.textField_2.setText(e.getApellido1());
			this.textField_3.setText(e.getApellido2());
			this.textField_4.setText(e.getDni());
			this.textField_5.setText(e.getDireccion());
			this.textField_6.setText(e.getEmail());
			this.textField_7.setText(e.getTelefono());

		}
		
		// Habilito y deshabilito botones de navegación
		if (ControladorEstudiante.findPrevious(Integer.parseInt(textField.getText())) == null) {
		...
		if (ControladorEstudiante.findNext(Integer.parseInt(textField.getText())) == null) {
